...
const nobot = "628971724481" // Ganti No Bot Kalian
const namabot = "AinulBotz" // Ganti Nama Bot Kalian
const nameown = "Ainul" // Ganti Nama Kalian
const numown = "0857-5420-2785" // Ganti Nomor Kalian
const nameowner = "Ainul" // Ganti Nama Kalian
const footer = "AinulBotz MD 2022" // Ganti Nama Bot Kalian
const capt = "*By AinulBotz MD*" // Ganti Nama Bot Kalian
const grup = "https://chat.whatsapp.com/CX2P0QnBXya9irl5xJJKH6" // Ganti Link Group Kalian
const nomorown = "https://wa.me/6285754202785" // Ganti Nomor Kalian
const note = "*_Bot Ini Masih Dalam Pengembangan Jika Ada Fitur Yang Eror Silakan Hubungi Owner!!!_*" // Kalau Mau Ganti Aja
const namagrup = "Group AinulBotz" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "0897-1724-481" // Ganti Nomor Gopay Mu
const pulsa = "0897-1724-481" // Ganti No Pulsa Mu
const insta = "Ainul_181" // Ganti Nama IG Mu
const github = "AinulBotz" // Ganti Nama Github Mu
const linkdonasi = "https://telegra.ph/AinulBotz-06-26" // Ganti Link Qris Mu

// Setting SewaBot Ubah Harga Sesuai Harga Mu//
const qris = "https://telegra.ph/AinulBotz-06-26"
const nomor = "wa.me/6285754202785"
const tujuhhari = "2.000"
const tigapuluhhari = "10.000"
const setahun = "100.000"
const permanen = "150.000"
...
if (chats.startsWith("@628971724481")){
...
*Script : https://github.com/AinulBotz*
...
_Sc Versi 2 Berpassword Syarat : Subscribe Dan Screenshot Kirim Ke Owner_`
...
⚠️ Segala kebijakan dan ketentuan Ainul Bot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user

Terima Kasih! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Ainul Bot
🙏`
...
case prefix+'infobot':
  case prefix+'inforobot':
    case prefix+'info':
      var caption = `*[ INFO AINUL BOT ]*

*Nama Bot :* AinulBotz - MD
*Name Owner :* Ainul
...
break
  ...
  ├─ ❏ 085754202785
  ├─ ❏ INSTAGRAM
  └─ ❏ https://www.instagram.com/ainul_181
...
conn.sendMessage(from, { text: slotnya, buttons: but, footer: "© Slot By Ainul\n@Ainul", templateButtons: but }, {quoted: msg})
gameAdd(sender, glimit)
        break
case prefix+'cekme':
  case prefix+'me':
